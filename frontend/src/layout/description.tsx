...
export default function Description(): JSX.Element {
  return (
    <div className="max-w-2xl lg:max-w-6xl mx-auto w-full flex flex-col px-6 lg:px-12 text-xs">
      ...
      <p className="mt-3"><span className="font-bold">Note:</span> page errors may occur while using this app. My next development priority is improving smart contract error handling. Please terminate the poll by clicking on the "End poll" button if it isn't already terminated and refresh the page if you encounter any errors until this issue is resolved.</p>
    </div>
  )
}